...
ICON_MAP = {"food": "mdi:apple", "garden": "mdi:tree", "refuse": "mdi:trash-can", "recycling": "mdi:recycle"}
...
class Source:
    ...
    def fetch(self):
        ...
        for row in table.tbody.find_all("tr"):
            ...
            entries.append(Collection(date=date, t=collection, icon=ICON_MAP.get(collection)))
