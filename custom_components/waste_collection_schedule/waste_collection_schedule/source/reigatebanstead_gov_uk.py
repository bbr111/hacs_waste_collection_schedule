...
class Source:
    ...
    def fetch(self):
        ...
        token_string = fromstring(token_data["data"])[0][0][1][0][0].text
        ...
        html_rowdata = fromstring(rowdata)[0][0][1][0][0].text or ""
            ...
            for bin_name in bins:
                ...
                entries.append(
                    Collection(
                        ...
                        icon=ICON_MAP.get(bin_name.text.upper().strip(), "mdi:trash-can"),
                    )
                )
