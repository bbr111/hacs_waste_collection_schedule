...
class Source:
    ...
    def fetch(self):
        ...
        r = requests.get(f"https://www.awr.de/api_v2/collection_dates/1/ort/{cityId}/strassen")
        r.raise_for_status()
        streets = r.json()
        ...
        r = requests.get(f"https://www.awr.de/api_v2/collection_dates/1/ort/{cityId}/abfallarten")
        r.raise_for_status()
        waste_types = r.json()
