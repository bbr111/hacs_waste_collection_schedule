...
if args.city and args.street:
    checked_addresses2.extend(line for line in checked_addresses if args.city.lower() in line and args.street.lower() in line)
    checked_addresses = checked_addresses2
elif args.street:
    checked_addresses2.extend(line for line in checked_addresses if args.street.lower() in line)
    checked_addresses = checked_addresses2
elif args.city:
    checked_addresses2.extend(line for line in checked_addresses if args.city.lower() in line)
    checked_addresses = checked_addresses2
